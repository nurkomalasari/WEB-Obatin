		  ...
		  <div class="header">
                   ...
                   <div class="col-md-9">
                       ...
                       <div class="card">
                                ...
                                @endif
                                            <form method="post" action="{{ url('/mitra/store_obat') }}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi_obat" class="form-control" placeholder="Deskripsi Obat"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="indikasi" class="form-control" placeholder="Indikasi">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="komposisi" class="form-control" placeholder="Komposisi"></textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="penyajian" class="form-control" placeholder="penyajian">
