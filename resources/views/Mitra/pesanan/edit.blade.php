                   ...
                   <div class="col-md-9">
                       ...
                       <div class="card">
                           <div class="card-action">
                                ...
                                <form role="form" method="post"  action="{{ url('transaksi-pesanan/update/'. $pesanan->id) }}" enctype="multipart/form-data"">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="jumlah_harga" class="form-control" placeholder="Jumlah Harga" value="{{$pesanan->jumlah_harga}}"  >
                                            ...
                                            <div class="form-group">
                                            <input type="number" name="status" class="form-control" placeholder="Status Pemesanan" value="{{$pesanan->status}}" >
                                    ...
                                    {{-- <div class="form-group">
                                        <label for="StatusPesanan">Status Pesanan</label>
                                            <select name="StatusPesanan" class="form-control">
                                                 ...
                                                 <option value="{{ $st->id }}" {{old('StatusPesanan')==$st->id?'selected':null}} >{{ $st->nama_status }}</option>
                                                    @endforeach
                                            </select>
                                    </div> --}}
                                    {{-- <div class="form-group">
                                        <label for="StatusPembayaran">Status Pembayaran</label>
                                            <select name="StatusPembayaran" class="form-control">
                                                 ...
                                                 <option value="{{ $sb->id }}" {{old('StatusPembayaran')==$sb->id?'selected':null}} >{{ $sb->nama_status }}</option>
                                                    @endforeach
                                            </select>
                                    </div> --}}
