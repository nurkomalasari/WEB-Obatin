        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="" class="waves-effect waves-dark"><i class="fa fa-shopping-cart"></i> Pesanan <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('transaksi-pesanan') }}" class="waves-effect waves-dark"><i class="fa fa-shopping-basket"></i> Transaksi</a>
                            </li>
                            <li>
                                <a href="{{ url('mitra/detail_pesanan') }}"> <i class="fa fa-shopping-basket"></i>Detail Pemesanan</a>
                            </li>
                        </ul>
                    </li>
